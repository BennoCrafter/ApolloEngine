...
class GameObject {
    constructor(renderable, x, y, width, height, rotation) {
        this.mRenderComponent = renderable;
        this.transform = this.getTransform()
        this.transform.setTransform(x,y,width,height,rotation)
        this.mVisible = true;
     ...
     */
    getTransform() { return this.mRenderComponent.getTransform(); }
    ...
    setCollider(c) { this.mCollider = c; }

    getCollider() { return this.mCollider}
