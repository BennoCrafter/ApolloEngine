...
import colorToRGB from "../utils/color_to_rgb.js"
...
class Renderable {
    ...
    draw(camera) {
        let gl = glSys.get();
        this.mShader.activate(this.mColor, this.transform.getTRSMatrix(), camera.getCameraMatrix());  // always activate the shader first!
